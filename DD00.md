...
$DC00-$DC01 for details of how these registers
...
data direction registers at $DC02-$DC03 for details of how
...
at [$DC0D](DC00#DC0D) for details of how this register operates.
...
[$DC0E](DC00#DC0E) and [$DC0F](DC00#DC0F), respectively, for details of
...
completed and the logical file for RS-232 is closed ($DD0E
...
logical file has been dosed ($DD0F will be set to
1/$01).
