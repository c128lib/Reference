...
to 2816/$0B00, the RS-232 input buffer pointer ([$C8-$C9](0000#C8))
to 3072/$0C00, and the RS-232 output buffer
...
Kernal memory initialization flag (2562/$0A02) is set to
...
custom mode setting (2618/$0A3A), and jiffy count compensation
...
57820/$EIDC. If the version number of the 8563 chip (bits
...
the initialization status flag (2564/$OA04) is tested. If the bit is
...
editor INIT80 routine [$C027] is called to copy the ROM character
...
serial flag (2588/$OAIC) and RS-232 activity flag ($0A0F) are cleared
