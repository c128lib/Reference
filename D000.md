...
routine [$E1O9], is 13/$0D (light green). From BASIC, the
...
$D800-$DBFF). The register at [53284/$D024](#D024) is unused in multicolor character mode.
...
$D01C](#D01C).) The value in the register at 53285/$D025 determines
