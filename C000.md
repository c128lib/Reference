...
<span class="badge badge-info">This routine has a screen editor jump table entry at [$C000](#C000) and a Kernal jump table entry at [$FF81](E000#FF81)</span>
...
<span class="badge badge-info">This routine has a jump table entry at [$C006](#C006)</span>
...
<span class="badge badge-info">This routine has a jump table entry at [$C009](#C009)</span>
...
<span class="badge badge-info">This routine has a screen editor jump table entry at [$C012](#C012) and a Kernal jump table entry at [$FF9F](E000#FF9F)</span>
...
<span class="badge badge-info">This routine has a jump table entry at [$C015](#C015)</span>
...
<span class="badge badge-info">This routine has a jump table entry at [$C00C](#C00C)</span>
...
[$C363](#C363). Upon return, the routine falls through into the next
...
Calls the subroutine to move the cursor one position to the
left [$CC00](#CC00). Upon return, the routine exits with the status
...
[$C194](#C194)). If the bit has previously been cleared, this has the effect of adding 2048/$0800 to the character base address.
...
during the next IRQ interrupt (see the screen IRQ routine
[$C194](#C194)). If the bit has been previously set to %1, this has the
...
[$C320](#C320) will be displayed in reverse video.
...
When autoinsert mode is active, the screen printing subroutine [$C320](#C320) calls this routine before each character is
...
<span class="badge badge-info">This routine has a screen editor jump table entry at [$C027](#C027) and a Kernal jump table entry at [$FF62](E000#FF62)</span>
