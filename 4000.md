...
{% assign mypage = site.html_pages | where_exp: "page", "page.title == '$4000'" %}
<div class="tooltip_code">Disassembled code<pre>{{mypage}}</pre></div>
...
{% assign mypage = site.html_pages | where_exp: "page", "page.title == '$4003'" %}
<div class="tooltip_code">Disassembled code<pre>{{mypage}}</pre></div>
...
{% assign mypage = site.html_pages | where_exp: "page", "page.title == '$4006'" %}
<div class="tooltip_code">Disassembled code<pre>{{mypage}}</pre></div>
...
{% assign mypage = site.html_pages | where_exp: "page", "page.title == '$4009'" %}
<div class="tooltip_code">Disassembled code<pre>{{mypage}}</pre></div>
...
{% assign mypage = site.html_pages | where_exp: "page", "page.title == '$4023'" %}
<div class="tooltip_code">Code<pre>{{mypage}}</pre></div>
...
{% assign mypage = site.html_pages | where_exp: "page", "page.title == '$4045'" %}
<div class="tooltip_code">Disassembled code<pre>{{mypage}}</pre></div>
